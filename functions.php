...
function flexieduca_widgets_init() {
    ...
    register_sidebar(array(
        'name' => esc_html__('Barra inferior de la página de inicio', 'flexieduca'),
        'id' => 'sidebar-3',
        'description' => esc_html__('Agregar widgets a la Barra inferior de la página de inicio.', 'flexieduca'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
        'before_title' => '<h2 class="widget-title">',
        'after_title' => '</h2>',
	...
	register_sidebar(array(
        'name' => esc_html__('Barra lateral del menú principal', 'flexieduca'),
        'id' => 'sidebar-contenidos',
        'description' => esc_html__('Agregar widgets a la barra lateral de contenidos.', 'flexieduca'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
        'before_title' => '<h2 class="widget-title">',
        'after_title' => '</h2>',
